...
public class Pigeon {
  ...
  public static final class PyTorchRect {
    ...
    static @NonNull PyTorchRect fromList(@NonNull ArrayList<Object> __pigeon_list) {
      PyTorchRect pigeonResult = new PyTorchRect();
      Object left = __pigeon_list.get(0);
      pigeonResult.setLeft((Double) left);
      Object top = __pigeon_list.get(1);
      pigeonResult.setTop((Double) top);
      Object right = __pigeon_list.get(2);
      pigeonResult.setRight((Double) right);
      Object bottom = __pigeon_list.get(3);
      pigeonResult.setBottom((Double) bottom);
      Object width = __pigeon_list.get(4);
      pigeonResult.setWidth((Double) width);
      Object height = __pigeon_list.get(5);
