...
void main() {
  ...
  group('Testing Model Runs', () {
    testWidgets('Run Classification Model on Small Image',
      ...
      int endTime = DateTime.now().millisecondsSinceEpoch;
      print(
          "Time taken for 'Run Classification Model on Small Image': ${endTime - startTime} ms");
    ...
    testWidgets('Run Classification Model on Large Image',
      ...
      int endTime = DateTime.now().millisecondsSinceEpoch;
      print(
          "Time taken for 'Run Classification Model on Large Image': ${endTime - startTime} ms");
      expect(imagePrediction, isNotNull);
    });
    ...
    testWidgets('Run Object Detection Model on Small Image',
      ...
      int startTime = DateTime.now().millisecondsSinceEpoch;
      Uint8List smallImageData = await _getImageBytes(pathToSmallTestImage);
      var objDetect = await objectModel.getImagePrediction(smallImageData,
          minimumScore: 0.1, iOUThreshold: 0.3);
      int endTime = DateTime.now().millisecondsSinceEpoch;
      print(
          "Time taken for 'Run Object Detection Model on Small Image': ${endTime - startTime} ms");
    ...
    testWidgets('Run Object Detection Model on Large Image',
      ...
      int startTime = DateTime.now().millisecondsSinceEpoch;
      Uint8List largeImageData = await _getImageBytes(pathToLargeTestImage);
      var objDetect = await objectModel.getImagePrediction(largeImageData,
          minimumScore: 0.1, iOUThreshold: 0.3);
      int endTime = DateTime.now().millisecondsSinceEpoch;
      print(
          "Time taken for 'Run Object Detection Model on Large Image': ${endTime - startTime} ms");
      expect(objDetect, isNotNull);
    });
    ...
    testWidgets('Run Object Detection Model YOLOv8 on Small Image',
      ...
      int startTime = DateTime.now().millisecondsSinceEpoch;
      Uint8List smallImageData = await _getImageBytes(pathToSmallTestImage);
      var objDetect = await objectModelYolov8.getImagePrediction(smallImageData,
          minimumScore: 0.1, iOUThreshold: 0.3);
      int endTime = DateTime.now().millisecondsSinceEpoch;
      print(
          "Time taken for 'Run Object Detection Model YOLOv8 on Small Image': ${endTime - startTime} ms");
      expect(objDetect, isNotNull);
    });
    ...
    testWidgets('Run Object Detection Model YOLOv8 on Large Image',
      ...
      int startTime = DateTime.now().millisecondsSinceEpoch;
      Uint8List largeImageData = await _getImageBytes(pathToLargeTestImage);
      var objDetect = await objectModelYolov8.getImagePrediction(largeImageData,
          minimumScore: 0.1, iOUThreshold: 0.3);
      int endTime = DateTime.now().millisecondsSinceEpoch;
      print(
          "Time taken for 'Run Object Detection Model YOLOv8 on Large Image': ${endTime - startTime} ms");
      expect(objDetect, isNotNull);
    });
  });
}
