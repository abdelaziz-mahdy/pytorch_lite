...
typedef NS_ENUM(NSUInteger, ObjectDetectionModelType) {
  ObjectDetectionModelTypeYolov5 = 0,
  ObjectDetectionModelTypeYolov8 = 1,
};
...
- (nullable NSNumber *)loadModelModelPath:(NSString *)modelPath numberOfClasses:(nullable NSNumber *)numberOfClasses imageWidth:(nullable NSNumber *)imageWidth imageHeight:(nullable NSNumber *)imageHeight objectDetectionModelType:(ObjectDetectionModelType)objectDetectionModelType error:(FlutterError *_Nullable *_Nonnull)error;
