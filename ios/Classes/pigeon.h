...
- (void)getPredictionCustomIndex:(NSInteger)index input:(NSArray<double> *)input shape:(NSArray<NSInteger> *)shape dtype:(NSString *)dtype completion:(void (^)(NSArray<id> *_Nullable, FlutterError *_Nullable))completion;
...
extern void SetUpModelApiWithSuffix(id<FlutterBinaryMessenger> binaryMessenger, NSObject<ModelApi> *_Nullable api, NSString *messageChannelSuffix);
