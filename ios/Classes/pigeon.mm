...
taskQueue:taskQueue];
    if (api) {
      NSCAssert([api respondsToSelector:@selector(loadModelModelPath:numberOfClasses:imageWidth:imageHeight:isObjectDetection:objectDetectionModelType:error:)], @"ModelApi api (%@) doesn't respond to @selector(loadModelModelPath:numberOfClasses:imageWidth:imageHeight:isObjectDetection:objectDetectionModelType:error:)", api);
      [channel setMessageHandler:^(id _Nullable message, FlutterReply callback) {
        ...
        NSNumber *arg_isObjectDetection = GetNullableObjectAtIndex(args, 4);
        NSNumber *arg_objectDetectionModelType = GetNullableObjectAtIndex(args, 5);
        FlutterError *error;
        NSNumber *output = [api loadModelModelPath:arg_modelPath numberOfClasses:arg_numberOfClasses imageWidth:arg_imageWidth imageHeight:arg_imageHeight isObjectDetection:arg_isObjectDetection objectDetectionModelType:arg_objectDetectionModelType error:&error];
